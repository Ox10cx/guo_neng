...
//    protected Paint innerBottomTextPaint;
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = BaseTools.sp2px(getResources(), 18);
        min_size = (int) BaseTools.dp2px(getResources(), 100);
        default_stroke_width = BaseTools.dp2px(getResources(), 10);
        default_inner_bottom_text_size = BaseTools.sp2px(getResources(), 18);
...
//        innerBottomTextPaint.setAntiAlias(true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float innerCircleRadius = (getWidth() - Math.min(finishedStrokeWidth, unfinishedStrokeWidth) + Math.abs(finishedStrokeWidth - unfinishedStrokeWidth)) / 2.5f;
        ...
        String text = this.text != null ? this.text : getResources().getString(R.string.configure);
